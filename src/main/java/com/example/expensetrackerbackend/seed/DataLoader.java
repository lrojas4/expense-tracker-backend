...
//            userService.registerUser(user3);
            ...
            Expense expense1 = new Expense(1L, new Date(2023, 05, 01), 1600.00, "rent");
            Expense expense2 = new Expense(2L, new Date(2023, 05, 5), 100.00, "groceries");
            Expense expense3 = new Expense(3L, new Date(2023, 05, 10), 30.00, "transportation");
            Expense expense4 = new Expense(4L, new Date(2023, 05, 23), 50.00, "entertainment");
            Expense expense5 = new Expense(5L, new Date(2023, 05, 30), 200.00, "insurance");
